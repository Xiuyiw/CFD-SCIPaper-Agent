...
| `v0.9.0` | Real-material whole-manuscript trial, bounded review and selected-feedback editing | Implemented locally, including full-report return, paired calculations, portable figure dependencies and evidence-linked revision tasks; release verification pending |
