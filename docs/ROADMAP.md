...
| `v0.9.0` | Real-material whole-manuscript trial, bounded review and selected-feedback editing | Direction approved; first-batch specification prepared; implementation not started |
